...
<img src="https://user-images.githubusercontent.com/89251393/139287265-49543fd9-2bb5-4b65-ac28-997b0723690d.png" width="350"/>
...
3. After completing the installation process download these files.
      ...
      1. [main.go](https://github.com/madhur3u/GO/blob/main/Password%20Generator/main.go)
      2. [go.mod](https://github.com/madhur3u/GO/blob/main/Password%20Generator/go.mod)
      3. [go.sum](https://github.com/madhur3u/GO/blob/main/Password%20Generator/go.sum)
...
go build main.go
```
7. To change the theme of application you need to add a line in [main.go](https://github.com/madhur3u/GO/blob/main/Password%20Generator/main.go).
```go
